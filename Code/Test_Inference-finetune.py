...
model_path = "H:/Repository/Llama-3.1-8B/Llama-fine-tuned/Llama-3.1-8B-Instruct-SciTail-FineTune-Lora"  # After merge
scitail_test_file = "H:/Repository/scitail/ProcessedData/scitail_test.txt"
output_csv_file = "scitail_predictions_leaderboard-FineTuned.csv"
...
print("Model loaded with 4Bit Quantization.")
